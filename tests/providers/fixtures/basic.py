...
def create_type_cases_table(dialect, table_name: str = "type_cases") -> CreateTableExpression:
    return CreateTableExpression(
        ...
        columns=[
            ...
            ColumnDefinition("decimal_val", DecimalType(precision=10, scale=6)),
            ColumnDefinition("char_val", CharType(length=10)),
            ColumnDefinition("varchar_val", VarCharType(length=50)),
