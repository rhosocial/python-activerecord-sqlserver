# src/rhosocial/activerecord/backend/impl/sqlserver/examples/cli/named_procedure_demo.py
"""
Named Procedure CLI demo script.

Demonstrates how to invoke named procedures (Named Procedure) via SQL Server CLI.
...
Or use CLI directly:
    python -m rhosocial.activerecord.backend.impl.sqlserver named-procedure \
        rhosocial.activerecord.backend.impl.sqlserver.examples.named_procedures.order_workflow.
